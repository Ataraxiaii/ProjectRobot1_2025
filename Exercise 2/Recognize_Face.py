...
# Date: 2025-06-25
# Version: 1.0
# Description: Recognize different faces
...
# Landmark detection and feature extraction models
ld5_kpu = KPU()
...
# Button interrupt for face registration
def set_key_state(*_):
...
while True:
    ...
    if len(dect) > 0:
        for l in dect :
            ...
            # Register new face on button press
            if start_processing:
